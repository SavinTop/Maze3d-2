...
void FloorModel::setParams(glm::vec2 size, const std::vector<std::shared_ptr<res::ogl::Texture>>& textures) 
{
    ...
    vertex1.Tangent = glm::vec3();
    vertex1.Bitangent = glm::vec3();
    ...
    vertex2.Tangent = glm::vec3();
    vertex2.Bitangent = glm::vec3();
    ...
    vertex3.Tangent = glm::vec3();
    vertex3.Bitangent = glm::vec3();
    ...
    vertex4.Tangent = glm::vec3();
    vertex4.Bitangent = glm::vec3();
