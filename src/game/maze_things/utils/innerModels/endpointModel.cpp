...
EndPointModel::EndPointModel(glm::vec3 size) 
{
    setParams(size);
}

void EndPointModel::setParams(glm::vec3 size) 
{
...
void EndPointModel::__draw(oglw::Shader& shader) 
{
    mesh.draw(shader);
}