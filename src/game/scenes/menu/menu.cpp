...
void Menu::onDraw(float delta) 
{
    ...
    projection = glm::ortho(0.0,600.0,0.0,600.0,0.1,100.0);
...
void Menu::initResources() 
{
    ...
    test = rm->createResource<>(res::ogl::Texture("data\\scenes\\mainMenu\\sprites\\buttons\\exit_active.png"),sceneName);
